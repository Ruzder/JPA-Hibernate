	...
	<div class="container">
		<div class="contact-box">
			...
			<div class="right">
				...
				<form
					action="${pageContext.request.getContextPath()}/editarCapacitacion/${c.getIdEntity()}"
					method="post">
					<input type="hidden" id="id" name="id" value="${c.getIdEntity()}">
					<div class="mb-3">
						<label for="dia" class="form-label">Dia</label><input type="text"
							class="form-control" id="dia" name="diaTxt" value="${c.getDiaEntity()}">
					</div>
					<div class="mb-3">
						<label for="hora" class="form-label">Hora</label><input
							type="text" class="form-control" id="hora" name="horaTxt"
							value="${c.getHoraEntity()}">

					</div>
					<div class="mb-3">
						<label for="lugar" class="form-label">Lugar</label><input
							type="text" class="form-control" id="lugar" name="lugarTxt"
							value="${c.getLugarEntity()}">

					</div>
					<div class="mb-3">
						<label for="duracion" class="form-label">Duracion</label><input
							type="text" class="form-control" id="duracionTxt" name="duracionTxt"
							value="${c.getDurEntity()}">

					</div>
					<div class="mb-3">
						<label for="rutCliente" class="form-label">RUT Cliente</label><input
							type="text" class="form-control" id="rutCliente"
							name="rutTxt" value="${c.getRutCliEntity()}">
					</div>
					<div class="col-12">
